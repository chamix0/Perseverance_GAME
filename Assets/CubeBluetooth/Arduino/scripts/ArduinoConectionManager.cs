...
public class ArduinoConectionManager : MonoBehaviour
{
    private MovesQueue _movesQueue;
    private RunProcessArduino _process;
    ...
    void Start()
    {
        _process = GetComponent<RunProcessArduino>();
    ...
    IEnumerator GetDevices()
    {
        ...
        arduinoManager.gameObject.SetActive(true);
        arduinoManager.isActive = true;
