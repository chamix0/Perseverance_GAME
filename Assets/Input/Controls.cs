...
public partial class @Controls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Any"",
                    ""type"": ""Button"",
                    ""id"": ""0f44b7aa-7541-4962-b2ed-18fca36e801a"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""d81ecb0d-b6a9-4ee5-881d-528301027fc6"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9f968fdc-dfaa-48e8-b7fb-f81aee2a6a52"",
                    ""path"": ""<Gamepad>/buttonSouth"",
                    ""interactions"": """",
                    ""processors"": """",
    ...
    ""controlSchemes"": [
        ...
        m_Eddo_Any = m_Eddo.FindAction("Any", throwIfNotFound: true);
        // Basic
    ...
    private List<IEddoActions> m_EddoActionsCallbackInterfaces = new List<IEddoActions>();
    ...
    private readonly InputAction m_Eddo_Any;
    public struct EddoActions
    {
        ...
        public InputAction @Any => m_Wrapper.m_Eddo_Any;
        ...
        public void AddCallbacks(IEddoActions instance)
        {
            if (instance == null || m_Wrapper.m_EddoActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_EddoActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IEddoActions instance)
        {
            @GearUp1.started -= instance.OnGearUp1;
            @GearUp1.performed -= instance.OnGearUp1;
            @GearUp1.canceled -= instance.OnGearUp1;
        ...
        public void RemoveCallbacks(IEddoActions instance)
        {
            if (m_Wrapper.m_EddoActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IEddoActions instance)
        {
            foreach (var item in m_Wrapper.m_EddoActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_EddoActionsCallbackInterfaces.Clear();
    ...
    private List<IRotatingWallActions> m_RotatingWallActionsCallbackInterfaces = new List<IRotatingWallActions>();
    ...
    public struct RotatingWallActions
    {
        ...
        public void AddCallbacks(IRotatingWallActions instance)
        {
            if (instance == null || m_Wrapper.m_RotatingWallActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_RotatingWallActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IRotatingWallActions instance)
        {
            @RotateCW.started -= instance.OnRotateCW;
            @RotateCW.performed -= instance.OnRotateCW;
            @RotateCW.canceled -= instance.OnRotateCW;
        ...
        public void RemoveCallbacks(IRotatingWallActions instance)
        {
            if (m_Wrapper.m_RotatingWallActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IRotatingWallActions instance)
        {
            foreach (var item in m_Wrapper.m_RotatingWallActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_RotatingWallActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<IMinibossActions> m_MinibossActionsCallbackInterfaces = new List<IMinibossActions>();
    ...
    public struct MinibossActions
    {
        ...
        public void AddCallbacks(IMinibossActions instance)
        {
            if (instance == null || m_Wrapper.m_MinibossActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_MinibossActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IMinibossActions instance)
        {
            @Attack.started -= instance.OnAttack;
            @Attack.performed -= instance.OnAttack;
            @Attack.canceled -= instance.OnAttack;
        ...
        public void RemoveCallbacks(IMinibossActions instance)
        {
            if (m_Wrapper.m_MinibossActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IMinibossActions instance)
        {
            foreach (var item in m_Wrapper.m_MinibossActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_MinibossActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
